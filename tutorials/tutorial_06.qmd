...
<figure style="text-align:center">
  <img src="./images/world_cup_2014.jpg" style="width:60%">
...
For a one-sample test with unknown $\sigma$, use
...
gradethis::grade_this({
  ...
  if (is.data.frame(res) && all(c("statistic", "p") %in% names(res))) {
    ...
    if (isTRUE(all.equal(got_z, exp_z, tolerance = 1e-6)) &&
      ...
      fail("You ran a proportion test, but the result doesn't match the expected test (p = 0.045).")
    }
