...
::: {.decor-img}
![](./svgs/air_quality.jpg){alt="" aria-hidden="true"}
:::
...
::: {.decor-img}
![](./svgs/chick_weight.jpg){alt="" aria-hidden="true"}
:::
...
ggplot2::ggplot(
ChickWeight,
ggplot2::aes(x = reorder(factor(Diet), weight, FUN = median), y = weight)
) +
...
lo <- qs[1] - 1.5*diff(qs)
hi <- qs[2] + 1.5*diff(qs)
ggplot(ChickWeight, ggplot2::aes(weight)) +
geom_histogram(bins = 12) +
...
#| exercise: ex_hist
#| solution: true
p_hist <- ggplot2::ggplot(ChickWeight, ggplot2::aes(weight)) +
...
#| exercise: ex_box
#| solution: true
p_box <- ggplot2::ggplot(ChickWeight, ggplot2::aes(x = factor(Diet), y = weight)) +
ggplot2::geom_boxplot()
p_box
```
:::
...
#| exercise: ex_scatter
#| solution: true
p_scatter <- ggplot2::ggplot(ChickWeight, ggplot2::aes(Time, weight)) +
ggplot2::geom_point() +
