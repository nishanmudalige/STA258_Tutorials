...
institute: "University of Toronto Mississauga"
resources:
...
```{webr-r}
# Data is stored in an object called pengions.
# Modify the code below to filter complete cases

_____ = _____ %>% filter(complete.cases(.))
